  ...
  <div>
    ...
    <div class="ex_border margin_top_div3">
      <div class="div_display_flex">
        <div style="width:80%" class="font_size_16 font_color_10">{{myStoreData.province}}{{myStoreData.city}}{{myStoreData.area}}{{myStoreData.address}}</div>
        <div style="width:20%" class="font_size_13 font_color_10 text_right">{{myStoreData.distance}}km</div>
      </div>
      ...
      <div class="div_display_flex margin_top_div3">
        ...
        <div style="width:75%" class="font_size_13 font_color_10 margin_left_div2">门店电话：1232132123123{{myStoreData.phone}}</div>
